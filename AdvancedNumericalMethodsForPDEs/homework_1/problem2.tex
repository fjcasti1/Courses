...
\subfigure[$\Delta x=0.1$.]{\includegraphics[scale=0.53]{step_dx1e-1.png}}
\hspace{-0.9cm}
\subfigure[$\Delta x=0.01$.]{\includegraphics[scale=0.53]{step_dx1e-2.png}}
\hspace{-0.9cm}
\subfigure[$\Delta x=0.001$.]{\includegraphics[scale=0.53]{step_dx1e-3.png}}
