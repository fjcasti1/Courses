function Problem2bonus(M,N,CFL,boolMovie,design)
...
txt=['RESULTS_Design0',num2str(design)];
...
global Yin3; global period; global nperiod;
global nIterMax; global tol;

%% Read parameters
DATA=importdata(['Designs/Design',num2str(design),'.txt'],',');
designData=DATA.data;
a1=designData(1,1); b1=designData(1,2);
uavg1=designData(1,3); startTime1=designData(1,4);
a2=designData(2,1); b2=designData(2,2);
uavg2=designData(2,3); startTime2=designData(2,4);
a3=designData(3,1); b3=designData(3,2);
uavg3=designData(3,3); startTime3=designData(3,4);
ao=designData(5,1); bo=designData(5,2);
Yin1=designData(6,1); Yin2=designData(6,2);
Yin3=designData(6,3); period=designData(6,4);
