...
!  type and registered with the MPI library.)  
    ...
    real(DOUBLE):: xextent(6)  ! xmin, xmax, ymin, ymax, xnum, ynum
...
!  writing a message to ERROR_UNIT and calling MPI_ABORT.
    ...
    call basin_dim(xextent, me, npes, henonparams, uncert)
...
!---------CUT HERE---------------------------------------------------------
   subroutine basin_dim(xextent, me, npes, params, uncert)
...
!  run on multiple processors.
    ...
    real(DOUBLE), intent(in)::xextent(6)
    real(DOUBLE),intent(in):: params(2)
