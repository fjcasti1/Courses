...
\begin{figure}[H]
\centering
\includegraphics[scale=0.75]{P1_b.png}\caption{Solution to the BVP using Chebyshev matrices and 51 nodes.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.75]{P1_a.png}\caption{Value of $u(0)$ for different number of nodes.}
\end{figure}
